    ...
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
      <AnimatedSection>
        <p className="mx-auto mb-10 max-w-2xl text-center text-lg font-medium leading-relaxed text-white md:text-xl">
          Tapahtumassa tarjolla monipuolisesti maksuttomia työpajoja - et tarvitse aiempaa kokemusta!
        </p>
      </AnimatedSection>
        ...
        {workshops.map((w, i) => {
          ...
          return (
            <AnimatedSection key={w.id} delay={i * 0.1}>
              <div className="group rounded-2xl border border-white/10 bg-[#0f0f1a] p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-teal-500/40">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-teal-500/10 transition-colors group-hover:bg-teal-500/20">
